...
(function($) {
	...
	function SlideToHome(){
		...
		$('nav a.to-left .arrow-label').html("más info");
		$('nav a.to-right').attr("data-direction","contact");
		$('nav a.to-right .arrow-label').html("contactos");
	}
	...
	$(window).load(function(e) {
		...
		var showContent = setTimeout(function(){
			...
			$("#wordrotator").wordsrotator({
    			...
    			words: ['artículos<br><span class="highlight">para bebés</span>', 'Hecho en<br><span class="highlight">Paraguay</span>']  	//-- Array of words, it may contain HTML values
			});
